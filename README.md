...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <bean id="helloService" class="com.ucaner.springboot.service.HelloService"></bean>
</beans>
```
...
```properties
logging.level.com.ucaner=trace
...
public class MyMvcConfig extends WebMvcConfigurerAdapter {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
       // super.addViewControllers(registry);
        //浏览器发送 /ucaner 请求来到 success
        registry.addViewController("/ucaner").setViewName("success");
    }
}
```
...
<form>
    ...
    <div class="form-group">
        <label>Email</label>
        <input type="email" class="form-control" placeholder="zhangsan@ucaner.com">
    </div>
    <div class="form-group">
...
-->
    ...
    <div class="form-group">
        <label>Email</label>
        <input name="email" type="email" class="form-control" placeholder="zhangsan@ucaner.com" th:value="${emp!=null}?${emp.email}">
    </div>
    <div class="form-group">
        <label>Gender</label><br/>
        <div class="form-check form-check-inline">
...
@MapperScan(value = "com.ucaner.springboot.mapper")
@SpringBootApplication
...
com.ucaner.springboot.listener.HelloApplicationContextInitializer

org.springframework.boot.SpringApplicationRunListener=\
com.ucaner.springboot.listener.HelloSpringApplicationRunListener
```
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <groupId>com.ucaner.starter</groupId>
    <artifactId>ucaner-spring-boot-starter</artifactId>
    ...
    <dependencies>
        ...
        <dependency>
            <groupId>com.ucaner.starter</groupId>
            <artifactId>ucaner-spring-boot-starter-autoconfigurer</artifactId>
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
   ...
   <name>ucaner-spring-boot-starter-autoconfigurer</name>
...
```java
package com.ucaner.starter;

import org.springframework.boot.context.properties.ConfigurationProperties;

@ConfigurationProperties(prefix = "ucaner.hello")
...
public class HelloService {
    ...
    public String sayHellucaner(String name){
